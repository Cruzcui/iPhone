...
- (void)performLayout {
    ...
    if ([self.navigationController.viewControllers objectAtIndex:0] == self) {
        ...
        [btnBack addTarget:self action:@selector(doneButtonPressed:) forControlEvents:UIControlEventTouchUpInside];
        ...
        UIBarButtonItem *doneButton = [[[UIBarButtonItem alloc] initWithCustomView:btnBack] autorelease];
        // Set appearance
...
- (void)actuallyEmailPhoto:(id<MWPhoto>)photo {
    if ([photo underlyingImage]) {
        ...
        emailer.navigationBar.barStyle = UIBarStyleBlackOpaque;
